...
WebUI.verifyElementText(findTestObject('CONTENT/Upload_Images/h1_Upload Images_Header_Text'), 'Upload Images')
...
not_run: WebUI.click(findTestObject('CONTENT/Upload_Images/label_Select Files'))
