...
Object excelfile = ExcelFactory.getExcelDataWithDefaultSheet("C:\\Users\\Dell\\Katalon Studio\\SampleTestProject\\Data Files\\xlsx files\\AMP.xlsx", "RoleListingPageAttributes", true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('HeaderMenus/adminmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 1), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('HeaderMenus/audiencemenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 2), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('HeaderMenus/contentmeu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 3), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('HeaderMenus/messagingmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 4), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('HeaderMenus/reportingmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 5), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('HeaderMenus/adminmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 6), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/LoginPage/accountssubmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 8), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/LoginPage/usersubmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 9), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/LoginPage/featuressubmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 10), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/LoginPage/licensingsubmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 11), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/LoginPage/programssubmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 12), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/LoginPage/eventssubmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 14), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/LoginPage/compliancesubmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 15), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/LoginPage/rolessubmenu'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 16), true)
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/LoginPage/rolemanagertext'), FailureHandling.CONTINUE_ON_FAILURE), excelfile.getValue("element_text", 17), true)
