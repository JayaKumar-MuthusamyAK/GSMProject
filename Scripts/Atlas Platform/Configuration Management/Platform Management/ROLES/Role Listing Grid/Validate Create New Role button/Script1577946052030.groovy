...
WebUI.callTestCase(findTestCase('Atlas Platform/Configuration Management/Platform Management/ROLES/Roles_Navigation'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('ROLES/Create Role/New Role_page/div_CancelCreate'), 0)
