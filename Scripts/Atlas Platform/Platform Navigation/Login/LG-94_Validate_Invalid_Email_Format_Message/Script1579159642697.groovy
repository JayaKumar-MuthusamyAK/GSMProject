...
WebUI.verifyElementText(findTestObject('Login_Page/Page_/Error Message-Invalid Email Format'), findTestData('AMP').getValue(6, 1), 
    FailureHandling.CONTINUE_ON_FAILURE)

String email_clr_act = WebUI.getCSSValue(findTestObject('Login_Page/Page_/Error Message-Invalid Email Format'), findTestData('AMP').getValue(
        5, 2))
